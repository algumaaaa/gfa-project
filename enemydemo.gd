...
onready var camera = get_tree().get_root().get_node("/root/menu/Spatial/Camera")
...
#				aistate = AI.DIE
#
#	if ray.is_colliding() and !tookdamage and aistate != AI.DIE and aistate != AI.GORE and aistate != AI.GIB:
